function getNaturalNumberGenerator() { // public function
...
function getnatnum(counter){
    ...
    return function natgen(fn){
        if (fn){counter = fn(counter);}
        return counter++;
    };
}

var gen2 = getnatnum(10);
console.log(gen2(function(test){
    console.log('>>', test++);
    console.log('>>', test);
    return test;
}));
...
var obj = { // (this) context =/= oblast na vidimost (promenlivi koito imame vuv funkciq)
